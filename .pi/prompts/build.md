...
8. For browser-visible behavior, use `browser-qa` and exercise the accepted journey in the real application. For visually significant work, run the product and studio passes, capturing desktop/mobile/demanding-state evidence and the visual-quality score. Add/update deterministic regression coverage when practical.
